(function () {
    ...
    var videoFileLocations = {
        "121": "./121VideoData.json",
        "122": "./122VideoData.json",
        "121P": "./121PVideoData.json",
    }
    ...
    if (!recievedDataFromQuery) {
        ...
        if (isNaN(course_module)) {
            throwError("The course code and module have not been given for this exercise.")
            return;
        }
        course = window.name;
    } else {
            ...
            $.getJSON(videoDataFile, function (data) {
                ...
                $("#videoFrameLoader").animate({
                    ...
                    if (data[parseInt(Module) - 1] === undefined) {
                        var errorMsg1 = 'You have entered an invalid module code. Please make sure that the module code <b style="text-decoration: underline">' + Module + " </b> is correct";
                        throwError((Module !== undefined && Module !== "") ? Module : "You have not entered a module code. Please enter a module code so we can load the proper data for this module");
                    } else {
                ...
                var errorMsg1 = 'You have entered an invalid course code. Please make sure that the course code <b style="text-decoration: underline">' + course + "</b> is correct";
                throwError((course !== undefined && course !== "") ? errorMsg1 : "You have not entered a course code. Please enter a course code so we can load the proper data for this module");
            });
